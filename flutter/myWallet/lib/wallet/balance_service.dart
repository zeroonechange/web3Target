...
class BalanceService{
  ...
  static String uniTokenAbi = '{"constant":true,"inputs":[{"internalType":"address","name":"account","type":"address"}],"name":"balanceOf","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"}';
  ...
  static Future<String> getTotalBalance(String publicAddress) async{
    ...
    String tokenAddresses = TopTokens.ethTopTokens.map((e) => e[1]).toList().join(",");
    ...
    /*  network.client.call(
          ...
          params: [publicAddress, tokens]).then((value) => _balancesResult = value),*/

      network.client.call(
          contract: uniContract,
          function: uniContract.function("balanceOf"),
          // params: ["0x5E46077F3DD9462D9F559FF38F76d54F762e79fF"]
    ...
    print('uni balance: ${_balancesResult.toString()}');
