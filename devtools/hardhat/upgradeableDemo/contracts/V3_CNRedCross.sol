...
/*
    构建可升级合约   使用标准的 Universal Upgradeable Proxy Standard (UUPS)   通用可升级代理标准 
                    1822号协议   https://eips.ethereum.org/EIPS/eip-1822   
...
/**
 * 使用 https://wizard.openzeppelin.com/#erc20  生成的合约代码  mintable ownable UUPS 
 * 
 * 和 V2 的差异是什么? 
 * 
 */