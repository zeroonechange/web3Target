...
contract ERC20Test is Test {
    ...
    function test_Permit() public {
        ...
        bytes32 digest = sigUtils.getTypedDataHash(permit);  // 计算其摘要

        (uint8 v, bytes32 r, bytes32 s) = vm.sign(ownerPrivateKey, digest);  // 对摘要进行签名  存储签名的 uint8 v, bytes32 r, bytes32 s
