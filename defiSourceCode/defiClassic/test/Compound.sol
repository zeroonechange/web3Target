...
contract ContractTest is Test {
    ...
    function testSupplyRedeem() public {
        ...
        uint256 cTokenAmount = C_WBTC.balanceOf(address(this));
    ...
    function testliquidate() public {
        ...
        (rerror, liquidity, shortfall) = comptroller.getAccountLiquidity(address(this));
        ...
        (error, liquidity, shortfall) = comptroller.getAccountLiquidity(address(this));
        ...
        uint256 repayAmount = (borrowedBalance * closeFactor) / 10 ** 18;
        emit log_named_uint("repayAmount:", repayAmount / 10 ** 18);

        (uint256 e, uint256 cTokenCollateralAmount) =
            comptroller.liquidateCalculateSeizeTokens(address(CDAI), address(C_WBTC), repayAmount);
        ...
        uint256 liquidated = C_WBTC.balanceOfUnderlying(address(0xcd6Eb888e76450eF584E8B51bB73c76ffBa21FF2));
        emit log_named_decimal_uint("liquidated: ", liquidated / 10000, 4); //0.3411

        emit log_named_decimal_uint(
            "C_WBTC balance of liquidator:", C_WBTC.balanceOf(0xcd6Eb888e76450eF584E8B51bB73c76ffBa21FF2), 8
        );
    }

    function estimateBalanceOfUnderlying() public returns (uint256) {
        uint256 cTokenBal = C_WBTC.balanceOf(address(this));
        uint256 exchangeRate = C_WBTC.exchangeRateCurrent();
    ...
    function borrow(address _cTokenToBorrow, uint256 _decimals) public {
        // enter market
    ...
    function repay(address _tokenBorrowed, address _cTokenBorrowed, uint256 _amount) public {
