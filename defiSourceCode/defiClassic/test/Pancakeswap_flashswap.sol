...
contract ContractTest is Test {
    ...
    function testPancakeswap_flashswap() public {
        ...
        emit log_named_uint("Before flashswap, WBNB balance of user:", wbnb.balanceOf(address(this)));
        //Borrow 1,000 BNB
        PancakePair.swap(0, 1000 * 1e18, address(this), data);
    }

    function pancakeCall(address sender, uint256 amount0, uint256 amount1, bytes calldata data) public {
        emit log_named_uint("After flashswap, WBNB balance of user:", wbnb.balanceOf(address(this)));
        wbnb.transfer(0x0eD7e52944161450477ee417DE9Cd3a859b14fD0, 1020 * 1e18);
        emit log_named_uint("After repay, WBNB balance of user:", wbnb.balanceOf(address(this)));
    }
