...
contract ContractTest is Test {
    ...
    function setUp() public {
        vm.createSelectFork("https://eth-mainnet.g.alchemy.com/v2/qXFbrurfVJ5Le9N3T3HwEi8Wc06v0Ud3", 15357717);
    ...
    function testSubmitProposal() public {
        ...
        console2.log("COMP balance:", COMP.balanceOf(address(this)), 18);
        ...
        _calldata[0] = abi.encode(address(this), 200000 * 1e18);
        vm.roll(15357719);
        ...
        (uint256 proposalid) = governance.propose(_target, _value, _signature, _calldata, "Add the FTS token as collateral.");
