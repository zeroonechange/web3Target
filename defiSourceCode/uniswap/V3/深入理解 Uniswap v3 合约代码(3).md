...
扩容预言机观测点的可写入空间，该方法调用[Oracle.sol](#Oracle.sol)的[grow](#grow)方法实现扩容。
...
批量获取指定时间的观测点数据，该方法调用[Oracle.sol](#Oracle.sol)的[observe](#observe2)实现。
...
请参考：[Uniswap v3 Oracle 预言机](/pcnFjAMCRtSDMQ0yVVlv4w)
